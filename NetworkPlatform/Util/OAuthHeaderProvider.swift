//
//  OAuthHeaderProvider.swift
//  NetworkPlatform
//
//  Created by Ashkan Ghaderi on 2021-12-12.
//

import Foundation

public class OAuthHeaderProvider
{
...
public extension URLRequest
{
    ...
    mutating func oAuthSign(method: String, urlFormParameters paras: [String: String],
        consumerCredentials cc: OAuthHeaderProvider.Credentials, userCredentials uc: OAuthHeaderProvider.Credentials? = nil)
    {
        self.httpMethod = method.uppercased()
        
        let body = OAuthHeaderProvider.httpBody(forFormParameters: paras)
        ...
        let sig = OAuthHeaderProvider.calculateSignature(url: self.url!, method: self.httpMethod!,
